...
import com.ionisph.chem.notation.HELMUtils;
...
public class ThreePrimeChemistry implements EvolveFunction {
    String field_name = null;
    String params = null;
    ABTable table = null;

    public ThreePrimeChemistry(String field_name, String params, ABTable t) {
    ...
    public void eval(GRow gRow) {
        ...
        try {
            ...
            String threePrimeChain = pullThreePrime(helm2notation);
...
//        System.out.println("-0---- chemistry : " + chemistry);
    ...
    private static String pullThreePrime(HELM2Notation notation) {
                ...
                for (ConnectionNotation cn : polymer_connections) {
                    ...
                    if (poi.getId().equalsIgnoreCase(target)) {
                        if (targetunit != null && targetunit.length() > 0) {
                            ...
                            if ((sui - 2) <= numMonomers && (sui + 2) >= numMonomers) {
