...
public class RegExFillDownField implements FieldAction {
	 ...
	 * 
	 * 
	 * table.field.set(query,field,regularexpression,value)
	 * 
	 */
	
	
	public RegExFillDownField(TNode node, ArrayList<GColumn> cols,
