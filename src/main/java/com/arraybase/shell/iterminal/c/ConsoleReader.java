...
import com.arraybase.shell.iterminal.Terminal;
import com.arraybase.shell.iterminal.TerminalFactory;
import com.arraybase.shell.iterminal.UnixTerminal;
import com.arraybase.shell.iterminal.c.autocmplt.CandidateListCompletionHandler;
import com.arraybase.shell.iterminal.c.autocmplt.Completer;
import com.arraybase.shell.iterminal.c.autocmplt.CompletionHandler;
import com.arraybase.shell.iterminal.c.history.History;
import com.arraybase.shell.iterminal.c.history.MemoryHistory;
 ...
 * function properly. See {@link Terminal#init} for convenience
...
public class ConsoleReader
{
    ...
    public void appendOnRedraw(String _string) {
        append = _string;
    }
     ...
     * Output put the prompt + the current buffer
     */
    public final void drawLineNoPrompt() throws IOException {
        String prompt = getPrompt();
        if (prompt != null) {
            print(prompt);
        }
...
//            flush();
    ...
    public final int readCharacter() throws IOException {
        ...
        int c = reader.read();
//        System.out.println ( " key stroke : "+ c );
        if (c >= 0) {
...
//        flush();
    ...
    public boolean paste() throws IOException {
        ...
        try {
            ...
            if (content instanceof Reader) {
                ...
                read = new BufferedReader((Reader) content);
	...
	public void setCursorBuffer(String t) {
		buf.setBuffer ( t );
