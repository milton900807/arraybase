...
public class XLStoCSV{
    ...
    public void convertExcelToCSV(String strSource, String strDestination)
        ...
        // Simply chain the call to the overloaded convertExcelXLStoCSV(String,
     ...
     *        defined to support this option; XLSXLStoCSV.EXCEL_STYLE_ESCAPING and
     *        XLSXLStoCSV.UNIX_STYLE_ESCAPING
     ...
     *         one of the values defined by the constants XLSXLStoCSV.EXCEL_STYLE_ESCAPING
     *         and XLSXLStoCSV.UNIX_STYLE_ESCAPING.
     * @throws org.apache.poi.openxml4j.exceptions.InvalidFormatException Thrown
     *         if the xml markup encounetered whilst parsing a SpreadsheetML
     *         file (.xlsx) is invalid.
     */
     ...
     *            an Excel workbook.
     */
    private void rowXLStoCSV(Row row) {
        Cell cell = null;
        int lastCellNum = 0;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if(args.length == 2) {
                ...
                //a Usage message.
                System.out.println("Usage: java XLStoCSV [Source File/Folder] " +
                    ...
                    "\t\t\t\tfolder must exist before running the XLStoCSV\n" +
